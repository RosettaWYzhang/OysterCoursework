...
public class Example {
    ...
    public static void OverCap() throws Exception {
        ...
        travelTracker.connect(paddingtonReader, bakerStreetReader, kingsCrossReader,angelReader);
...
//        minutesPass(15);
        kingsCrossReader.touch(myCard);
//        minutesPass(15);
        angelReader.touch(myCard);
        travelTracker.chargeAccounts();


    }

    public static void FredBloggs()throws Exception{
        OysterCard myCard = new OysterCard("38400000-8cf0-11bd-b23e-10b96e4ef00d");
        OysterCardReader paddingtonReader = OysterReaderLocator.atStation(Station.PADDINGTON);
        OysterCardReader bakerStreetReader = OysterReaderLocator.atStation(Station.BAKER_STREET);
        OysterCardReader kingsCrossReader = OysterReaderLocator.atStation(Station.KINGS_CROSS);
